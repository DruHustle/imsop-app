# IMSOP - Render Deployment Guide

This guide explains how to deploy the IMSOP backend service on Render and connect it to an Aiven MySQL database.

## Prerequisites

- Render account (https://render.com)
- Aiven account (https://aiven.io)
- GitHub repository with the IMSOP code
...
5. Name your service (e.g., `imsop-db`)
...
4. Select your GitHub account and the `imsop-app` repository
5. Click "Connect"

### 2.2 Configure Web Service
1. **Name**: `imsop-api` (or your preferred name)
2. **Environment**: `Node`
...
NODE_ENV=production
PORT=3000
DATABASE_URL=mysql://user:password@your-aiven-host.aivencloud.com:3306/imsop
JWT_SECRET=your-strong-random-secret-key
VITE_APP_ID=imsop
VITE_APP_TITLE=IMSOP - Supply Chain Platform
...
3. Once deployment is complete, you'll get a URL like: `https://imsop-api.onrender.com`
...
1. Connect to your Aiven database using a MySQL client:
   ```bash
   mysql -h your-aiven-host -u user -p -D imsop
   ```
...
- IMSOP API Documentation: See `API.md`
